...
#show: project.with(
  ...
  title_en: "Based on Typst, the Graduation Thesis Template of Sichuan University School of Computer Science",
  author_en: "Your Name",
  mentor_en: "Your Mentor",
  major_en: "Computer Science and Technology",
  abstract_en: [
  The emperor died before he could finish his work, and the country was divided into three parts. Yizhou was weak and exhausted, and the situation was critical. The ministers of the emperor's court were diligent in their duties, and the loyal and righteous
  ],
...
#acknowledgement()[
  ...
  最后，我想感谢所有阅读本文的读者，你们的反馈和评价对我非常重要，这也让我意识到了自己写作方面的不足，同时更加明白了自己的研究方向。谢谢大家！

  再次向所有支持和鼓励我的人表达我的谢意和感激之情。

  本致谢生成自 GitHub Copilot。
]
